    ...
    <div className="min-h-screen bg-c-base flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <div className="bg-c-card border border-c-border rounded-xl shadow-sm w-full p-7">
          <h2 className="text-lg font-bold text-c-text mb-1">Welcome back</h2>
          <p className="text-c-dim text-sm mb-5">Sign in to your planner</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-baseline justify-between mb-1">
                <label className="block text-sm font-medium text-c-muted">Password</label>
                <Link to="/forgot-password" className="text-xs text-c-accent hover:underline font-medium">
                  Forgot?
                </Link>
              </div>
              <input
        ...
        <p className="mt-6 text-center text-sm text-c-dim">
          No account?{' '}
          <Link to="/register" className="text-c-accent hover:underline font-semibold">
            Create one
          </Link>
        </p>

        <p className="mt-3 text-center text-xs text-c-faint flex items-center justify-center gap-3">
          <Link to="/about" className="text-c-faint hover:text-c-dim no-underline">
            About
          </Link>
          <span aria-hidden>·</span>
          <Link to="/privacy" className="text-c-faint hover:text-c-dim no-underline">
            Privacy
          </Link>
          <span aria-hidden>·</span>
          <Link to="/terms" className="text-c-faint hover:text-c-dim no-underline">
            Terms
          </Link>
        </p>
      </div>
